...
const METAS: Record<string, CompanyMeta> = {
  ...
  'microsoft': { employees: 228000, faang: true },
  'nvidia': { employees: 31000, faang: true },
  'tesla': { employees: 140000, faang: true },
  'alphabet': { employees: 183000, faang: true },
  'facebook': { employees: 74000, faang: true },
  'openai': { employees: 2500, faang: true },
  'anthropic': { employees: 2000, faang: true },
  ...
  'nvidia corporation': { employees: 31000, faang: true },
  ...
  'oracle': { employees: 159000, faang: true },
  'oracle cloud': { employees: 159000, faang: true },
  'ibm': { employees: 282000, faang: true },
  'salesforce': { employees: 72000, faang: true },
  'salesforce inc': { employees: 72000, faang: true },
  'adobe': { employees: 30000, faang: true },
  'adobe inc': { employees: 30000, faang: true },
  ...
  'snowflake': { employees: 8000, faang: true },
  'palantir': { employees: 4000, faang: true },
  'palantir technologies': { employees: 4000, faang: true },
  'crowdstrike': { employees: 8000, faang: false },
  'stripe': { employees: 8000, faang: true },
  'stripe inc': { employees: 8000, faang: true },
  'coinbase': { employees: 4000, faang: true },
  'square': { employees: 13000, faang: true },
  'block': { employees: 13000, faang: true },
  'robinhood': { employees: 4000, faang: false },
  'robinhood markets': { employees: 4000, faang: false },
  'paypal': { employees: 30000, faang: true },
  'paypal holdings': { employees: 30000, faang: true },
  'airbnb': { employees: 7000, faang: true },
  'airbnb inc': { employees: 7000, faang: true },
  'uber': { employees: 33000, faang: true },
  ...
  'shopify': { employees: 9000, faang: true },
  'shopify inc': { employees: 9000, faang: true },
  'spotify': { employees: 9000, faang: true },
  'spotify usa': { employees: 9000, faang: true },
  'twitter': { employees: 1500, faang: false },
  'x corp': { employees: 1500, faang: false },
  'linkedin': { employees: 20000, faang: true },
  'linkedin corporation': { employees: 20000, faang: true },
  'snap': { employees: 5000, faang: true },
  'snap inc': { employees: 5000, faang: true },
  ...
  'twitch': { employees: 1500, faang: true },
  ...
  'databricks': { employees: 7000, faang: true },
  'databricks inc': { employees: 7000, faang: true },
  ...
  'tiktok': { employees: 150000, faang: true },
  'bytedance': { employees: 150000, faang: true },
  'tiktok pte': { employees: 150000, faang: true },
...
export function matchCompanyMeta(name: string): CompanyMatch | null {
  ...
  // Noisy ATS names (e.g. "Google LLC", "Amazon Web Services (AWS)"): match a
  // canonical entry only as a contiguous run of whole words — never a substring
  // of a longer word, or "Commercial Metals" becomes "meta" and "Physical
  // Intelligence" becomes "intel".
  const words = name.toLowerCase().split(/[^a-z0-9]+/).filter(Boolean)
  for (const [raw, meta] of Object.entries(METAS)) {
    const kw = raw.toLowerCase().split(/[^a-z0-9]+/).filter(Boolean)
    if (!kw.length) continue
    for (let i = 0; i + kw.length <= words.length; i++) {
      if (kw.every((w, j) => words[i + j] === w)) {
        return { ...meta, canonical: raw }
      }
    }
  }
  return null
